            ...
            <div class="col-lg">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" class="form-control <?= form_error('alamat') ? 'is-invalid' : null ?>" id="alamat" placeholder="Alamat Lengkap" name="alamat" rows="3"><?= set_value('alamat'); ?></textarea>
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control<?= form_error('hp') ? ' is-invalid' : null ?>" id="hp" placeholder="Masukkan No HP" name="hp" autocomplete="off" value="<?= set_value('hp'); ?>">
