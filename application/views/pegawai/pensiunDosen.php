            ...
            <div class="col-lg">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control<?= form_error('jabatan') ? ' is-invalid' : null ?>" id="jabatan" placeholder="Masukkan jabatan" name="jabatan" autocomplete="off" value="<?= $datauser['jabatan_fungsi']; ?>" readonly>
